...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Insacoin Core insacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  insacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded insacoin transaction") + "\n" +
              "  insacoin-tx [options] -create [commands]   " + _("Create hex-encoded insacoin transaction") + "\n" +
              "\n";
